    ...
    <div className="min-h-screen py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="relative mb-16">
          ...
          <div className="relative text-center py-16 bg-gradient-to-r from-cyan-50 to-teal-50 rounded-lg">
        ...
        <section className="mb-16">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 relative overflow-hidden border-2 border-cyan-200 bg-cyan-50 hover:shadow-xl transition-all duration-300">
            ...
            <Card className="p-8 relative overflow-hidden border-2 border-teal-200 bg-teal-50 hover:shadow-xl transition-all duration-300">
              <CardContent className="pt-0 relative z-10">
                <div className="flex items-center mb-6">
        ...
        <section className="relative">
          ...
          <div className="relative max-w-4xl mx-auto text-center py-12 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg">
